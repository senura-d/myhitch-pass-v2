...
interface NeuralBackgroundProps {
   ...
   * Defaults to electric blue (#3b82f6) if not specified.
   */
  color?: string;
  /**
...
export default function NeuralBackground({
  className,
  color = "#3b82f6", // Default Electric Blue
  trailOpacity = 0.15,
  particleCount = 600,
  speed = 1,
  ...
  return (
    <div 
      ref={containerRef} 
      className={`fixed inset-0 w-full h-full bg-black overflow-hidden pointer-events-none z-[-1] ${className || ""}`}
